...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p(data-aos="fade-right") Teniendo en cuenta los diferentes propósitos que enmarca el sector del turismo, se ha establecido como objetivos principales entre otros, los siguientes:
    ...
    .row.justify-content-center.mb-5
      .col-xl-4.col-lg-7.col-md-9.mb-4(data-aos="fade-right")
        .crd_hover_txt
          .crd_hover_txt--img
            figure
      ...
      .col-xl-4.col-lg-7.col-md-9.mb-4(data-aos="flip-up")
        .crd_hover_txt
          .crd_hover_txt--img
            figure
      ...
      .col-xl-4.col-lg-7.col-md-9.mb-4(data-aos="fade-left")
        .crd_hover_txt
          .crd_hover_txt--img
            figure
    ...
    .row.justify-content-center.mb-4
      .col-auto.fondo2
        h3.text-white.text-center.px-5.py-2.mb-0 Beneficios del turismo

    .row.justify-content-center.align-items-center
      .col-lg-6.col-md-10.mb-5.mb-md-0(data-aos="fade-left")
        LineaTiempoD
      ...
      .col-lg-6(data-aos="fade-right")
        img.mt-4(src='@/assets/curso/tema1/imagen2.jpg', alt="Imagen decorativa")

    p.my-5(data-aos="fade-right") En cuanto a sus características, se pueden mencionar:
    
    .row.justify-content-center.mt-5
      .col-lg-6.col-10(data-aos="fade-left")
        img(src='@/assets/curso/tema1/imagen3.jpg', alt="Imagen decorativa")
      .col-lg-6.col-md-10.mt-4(data-aos="fade-right")
    ...
    .row.justify-content-center.fondo47
      .col-xxl-5.col-lg-5.col-5.p-0(data-aos="fade-left")
    ...
    p.mt-5(data-aos="fade-left") Los prestadores de servicios turísticos deben estar pendientes de que clientes o proveedores acaten las normas de operación local; adicionalmente deben asegurar la capacitación del personal de trabajo y hacer cumplir los principios de la actividad turística por parte de todos los visitantes. 
    ...
    p(data-aos="fade-left") Cualquier persona que se encuentre realizando un viaje (por cualquier motivo) entre lugares geográficamente distintos y fuera de su entorno habitual, se puede llamar viajero; sin embargo, cuando una persona se establece en otro lugar para trabajar, o porque son refugiados, diplomáticos o migrantes, no serán considerados viajeros.
    p.mb-5(data-aos="fade-left") Según esta definición y teniendo en cuenta que visitante es toda persona que se desplaza a una localidad donde no tiene fijada su residencia, Gurría (2004) categoriza estos viajeros en dos tipos (ver figura 1):
    ...
    .row.mb-5.justify-content-center.align-items-center
      .col-xxl-4.col-xxl.pe-0.col-xxl.me-3.col-xxl.pb-4.col-xl-5.col-lg-6.col-sm-10.col-12.col-lg.mb-5.mb-lg-0(data-aos="fade-left")
        .tarjeta-avatar
      ...
      .col-xxl-4.col-xxl.pe-0.col-xxl.me-3.col-xxl.pb-3.col-xl-5.col-lg-6.col-sm-10.col-12.col-lg.mb-5.mb-lg-0(data-aos="fade-right")
        .tarjeta-avatar
    ...
    .tabla-c.mb-5
      table
        caption Nota. <span style="font-weight: 400">Adaptado de Gutiérrez y Bordas (1993) por Cordente Rodríguez, M; Mondéjar Jiménez, J.A; Esteban Talaya, A (s.f.).</span>
    ...
    p.my-5(data-aos="fade-left") Así surgieron las primeras agencias de viajes, que posteriormente a mediados de siglo, con la llegada de la aviación al país, crecieron en mayor medida, porque tuvieron la oportunidad de incursionar en el ámbito internacional.
    ...
    p.my-5(data-aos="fade-left") En cuanto a las tendencias que rigen el turismo, se encuentra que la FITUR (2021), que es la feria de turismo más importante de España y Procolombia (2021), indica que entre las preferencias del turismo en los años entrantes estarán:
    .row.justify-content-center.align-items-center
    ...
    p.my-5(data-aos="fade-left") También se puede encontrar nuevas preferencias de los turistas a la hora de viajar como:
    ...
    p.my-5(data-aos="fade-left") En cuanto al turismo según la actividad desarrollada, en el siguiente recurso se podrá consultar con mayor detalle, la clasificación respectiva:
    .row.justify-content-center.mb-5(data-aos="fade-right")
      .col-xxl-6.col-xl-7.col-lg-8.col-md-10.col-12.fondo2
        h3.text-white.text-center.pt-2.pb-3.mb-0 Tipos de turismo según la actividad desarrollada
    //-slider    
    .tarjeta.tarjeta--azul.p-4.mb-5.fondo13(data-aos="fade-left")
    ...
    .tabla-c.mb-5(data-aos="fade-left")
      table
        caption Nota. <span style="font-weight: 400">SENA (2022).</span>
    ...
    .row.ampliarambos.fondo15
      .col.px-5
        ...
        .row.justify-content-center
          ...
          .col-xxl-7.col-lg-7.col-md-12.col-sm-12.col-12(data-aos="fade-left")
        ...
        .cajon.color-primario.p-4.mb-4.mt-4.fondo1(data-aos="fade-right")
        ...
        p.my-5(data-aos="fade-left") Este Registro Nacional de Turismo, brinda unos beneficios, entre los que se puede encontrar:
        ...
        .row.justify-content-center.mb-5
          .col-xxl-2.col-xl-3.col-lg-3.col-md-5.col-sm-5.col-6(data-aos="fade-left")
          ...
          .col-xxl-2.col-xl-3.col-lg-3.col-md-5.col-sm-5.col-6(data-aos="fade-right")
    ...
    p.mt-5(data-aos="fade-left") La última ley generada para regular las actividades del sector es la 2060 de 2020, esta ley modifica el programa de apoyo al empleo formal PAEF y el programa de apoyo para el pago de la prima de servicios PAP.
    p(data-aos="fade-left") Entre sus objetivos principales está fortalecer la sostenibilidad, la formalización y la competitividad del sector y promover la reactivación del turismo, para consolidar el país como un destino altamente reconocido, sostenible, responsable y de alta calidad. Además de tener como propósito fundamental, reactivar económicamente al sector después de un año de pandemia, combinando medidas de corto, mediano y largo plazo.
      ...
      .col.px-5
        ...
        .row.justify-content-center
          .col-xl-5.col-lg-6.col-md-10.col-sm-0.col-0(data-aos="fade-left")
            img.mb-5.nomostrar(src='@/assets/curso/tema1/medidas1.svg', alt="Imagen decorativa")
    ...
    .row.justify-content-center.fondo16.ampliarambos
      .col-xxl-12.px-5
        .row.justify-content-center(data-aos="fade-left")
          .col-xl-6.col-lg-7.col-md-10.col-sm-11.col-12
    ...
    .row.mb-4
      .col-xxl-12(data-aos="fade-right")
    ...
    .row.justify-content-center.mb-5
      .col-xl-4.col-lg-7.col-md-9.mb-4(data-aos="flip-right")
        .crd_hover_txt
          .crd_hover_txt--img
            figure
      ...
      .col-xl-4.col-lg-7.col-md-9.mb-4(data-aos="flip-left")
        .crd_hover_txt
          .crd_hover_txt--img
            figure
    ...
    SlyderF.mb-5(columnas="col-lg-6 col-xl-6" data-aos="zoom-in")
    ...
    .row.justify-content-center.mb-5
      .col-lg-6.col-10.mb-lg-0.mb-4(data-aos="fade-left")
        img.mt-4(src='@/assets/curso/tema1/imagen9.jpg', alt="Imagen decorativa")
    ...
    p(data-aos="fade-left") Los profesionales que participen de la creación del inventario tendrán la potestad para clasificar los atractivos en dos grupos: patrimonio cultural y sitios naturales. 
    p.mb-5(data-aos="fade-left") En cuanto al patrimonio cultural, se entienden que son todas aquellas manifestaciones culturales, materiales e inmateriales que se encuentran en permanente construcción sobre el territorio transformado por las comunidades. El patrimonio cultural tiene una clasificación propia, tal como se puede ver en el siguiente recurso:

    TabsC.color-primario.mb-4(data-aos="fade-up")
    ...
    .row.justify-content-between
      .col-lg-3.col-md-6.fondo23.p-5(data-aos="fade-left")
      ...
      .col-lg-3.col-md-6.fondo22.pt-3(data-aos="fade-up")
        .row
    ...
    p.mt-5(data-aos="fade-left") Cuando se piensa en crear productos turísticos, lo debe hacer de tal forma que sean novedosos, oportunos y eficaces para que aporten un valor económico, social y ambiental, tanto para el destino como para los turistas quienes finalmente los disfrutarán.
    ...
    .bloque-texto-g.fondo25.p-3.p-sm-4.p-md-5(data-aos="fade-left")
      .bloque-texto-g__img(
    ...
    p.my-5(data-aos="fade-left") Este tipo de sitios se basan en comentarios y críticas sobre los servicios que ofrecen puntualmente, por ejemplo: <i>TripAdvisor</i> muestra las opiniones sobre destinos turísticos, hoteles y restaurantes; Despegar.com muestra vuelos y hoteles; y <i>Airbnb</i> ofrece información sobre el alquiler de casas o apartamentos a precios realmente económicos.
    .row.justify-content-center.alineacion
      .col-lg-6(data-aos="fade-left")
      ...
      .col-lg-6.col-md-7.col-10(data-aos="fade-right")
          ...
          SlyderA.otroslide2(tipo="b")
            ...
            .row.justify-content-center
              ...
              .col-lg-12.col-md-12.mb-4.mb-md-0.px-4
                ...
                p Ideal para: hoteles y aerolíneas.
    .row
      .col-auto.fondomundo(data-aos="fade-left")
        h4.ps-5.pt-5.ms-5 Metabuscadores

    .row.justify-content-center.my-5
      .col-xl-5.col-lg-7(data-aos="fade-left")
        .cajon.puntacajon.p-4.mb-4.fondo17.sombracajon
      ...
      .col-xxl-7.col-xl-7.col-lg-10(data-aos="fade-right")
    ...
    .row.mb-5
      .col-xxl-12.fondonaranja.py-4.px-5(data-aos="fade-left")
    ...
    .row.justify-content-center.mb-5
      .col-xxl-6.col-xl-7.col-lg-8.col-md-10.col-12.fondo2(data-aos="fade-left")
    ...
    .row.justify-content-center
      .col-xl-6.col-lg-7.col-md-8
        ul.lista-ul
          ...
          li.otrocolorcheck(data-aos="fade-left")
            i.fas.fa-check(data-aos="fade-left")
      ...
      .col-xl-6.col-lg-5.col-md-4(data-aos="fade-right")
        img(src='@/assets/curso/tema1/imagen20.jpg', alt="Imagen decorativa")
    p.my-5(data-aos="fade-left") Entre los principales metabuscadores en turismo se encuentran Tripadvisor, Trivago, Kayak. Google Hotel Ads, en la siguiente figura 8 se encuentra una explicación más detallada al respecto:
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-3.col-md-6.col-10.mb-4(data-aos="fade-up")
    ...
    .row
      .col-xxl-7.col-xl-8.col-lg-9.col-md-12.col-sm-12.col-12.fondomundo2.pt-4.py-xs-1(data-aos="fade-left")
        h4.ps-4.ms-5.mt-3.mb-2.mt-lg-1 <i>Customer Relationship Management y Enterprise Resource Planning</i>
    p.my-5(data-aos="fade-left") Estas dos herramientas permiten la gestión del servicio y la relación que ejerce con el cliente o los clientes interesados, así como la fidelización de estos, posibilitando perdurabilidad en el tiempo, a continuación, se explica cada una de estas:
    ...
    .row.justify-content-center
      ...
      .col-xl-6.col-lg-5.col-10(data-aos="fade-right")
        img(src='@/assets/curso/tema1/imagen21.jpg', alt="Imagen decorativa")
    p.mt-5(data-aos="fade-right") Entre las ventajas de un ERP se pueden apreciar las siguientes (ver figura 10):
    ...
    .row.fondo28.ampliarambos.px-5.mb-4
      ...
      .row.justify-content-center
        .col-xxl-2.col-xl-2.col-lg-3.col-md-4.col-sm-5.col-6.mb-2(data-aos="fade-right")
    ...
    //-slider
    SlyderF.my-5(data-aos="fade-right")(columnas="col-lg-6")
      .tarjeta.otra.p-4.fondo19
        .row.justify-content-start.mb-3
          .col-4
    ...
    .row.justify-content-center.fondo29.ampliarambos
      .col-xl-6.col-lg-7.px-5(data-aos="fade-right")
      ...
      .col-xl-6.col-lg-5.col-10.px-5(data-aos="fade-left")
        img(src='@/assets/curso/tema1/figura5.svg', alt="Imagen decorativa")
    p.my-5(data-aos="fade-right") Adicional a lo anterior, se debe tener presente que cada paquete está conformado por unos servicios básicos y otros complementarios:
    ...
    p.my-5(data-aos="fade-right") Estos servicios se organizan dependiendo de varios factores, entre los que se deben tener en cuenta los siguientes, como se aprecia en la figura 11 a continuación:
    ...
    .row.justify-content-center
      .col-xxl-6.col-xl-7.col-lg-8.col-md-10.col-12.fondo2.mb-5(data-aos="fade-right")
        h3.text-white.text-center.pt-2.pb-3.mb-0 Ruta para la creación de un paquete turístico
    //-slider    
    .tarjeta.tarjeta--azul.p-4.mb-5.fondo7(data-aos="fade-right")
    ...
    p.my-5(data-aos="fade-right") Existen tres fases ligadas al ciclo de compra del cliente que están relacionadas con el proceso de venta de un paquete turístico, estas son:
    .row.justify-content-center
      .col-xl-6.col-lg-7(data-aos="fade-right")
        AcordionA.otroacordion2.otratarjetaazul2(tipo="b" clase-tarjeta="tarjeta tarjeta--azul")
          .row.justify-content-center(titulo="Fase anterior a la compra del paquete turístico")
            .col-lg-11
          ...
          .row.justify-content-center(titulo="Fase durante el consumo del paquete turístico")
            .col-lg-11
          ...
          .row.justify-content-center(titulo="Fase después del consumo del paquete turístico")
            .col-lg-11
    ...
    p.my-5(data-aos="fade-right") Las rutas turísticas se establecen por tipos, dependiendo de su finalidad, o su recorrido, en el siguiente recurso se ofrece esta diferenciación:
    p.subrayar.mb-5(data-aos="fade-right") Según su finalidad
    
    .row.justify-content-center.my-5
      .col-lg-6.mt-4(data-aos="fade-right")
        LineaTiempoD.color-secundario
    ...
    .row.justify-content-center
      .col-lg-5.col-sm-9.fondo35.p-4.me-3.mb-5(data-aos="fade-right")
        .row
          .col-sm-4.col-5
      ...
      .col-lg-5.col-sm-9.fondo36.p-4.me-3.mb-5(data-aos="fade-right")
        .row
          .col-sm-4.col-5
    ...
    .row.fondo30.ampliarambos.justify-content-center.px-5
      ...
      .col-xl-6.col-lg-5.col-10(data-aos="fade-left")
    ...
    .tarjeta.tarjeta--azul.p-4.my-5.fondo13
      SlyderA.pt-4.otroslide(tipo="b" data-aos="fade-right")
        .row.justify-content-center
          .col-lg-4.col-md-10.mb-4.mb-md-0
            h4 Hostal
    ...
    //-slider
    SlyderF.my-5(columnas="col-lg-6 col-xl-6" data-aos="fade-right")
    ...
    p.my-5(data-aos="fade-right") Según la explotación comercial, modalidad o temática escogida para llevar a cabo su oferta, los hoteles pueden especializarse en las siguientes:
    
    .row.justify-content-center
      .col-xxl-8.col-xl-8.col-lg-10.col-lg-11.col-12.fondo2.mb-5.py-3(data-aos="fade-right")
    ...
    .tarjeta.tarjeta--azul.p-4.mb-5.fondo7
      SlyderA.pt-4.otroslide3(tipo="b" data-aos="fade-right")
        .row.justify-content-center
    ...
    .row.justify-content-center
      .col-xl-6.col-lg-7.col-10(data-aos="fade-right")
      ...
      .col-xl-6.col-lg-5.col-md-9(data-aos="fade-left")
        img(src='@/assets/curso/tema1/imagen29.jpg', alt="Imagen decorativa")
    p.my-5(data-aos="fade-right") Según la explotación comercial, modalidad o temática escogida para llevar a cabo su oferta, los hoteles pueden especializarse en las siguientes:
    .row.justify-content-around 
      .col-lg-4.col-md-6.fondo37.p-5.mb-5(data-aos="fade-left")
      ...
      .col-lg-4.col-md-6.fondo38.p-5.mx-1.mb-5(data-aos="fade-up")
      ...
      .col-lg-4.col-md-6.fondo39.p-5.mb-5(data-aos="fade-right")
    ...
    .row(data-aos="fade-right")
      .col-xl-5.col-lg-6.col-md-9.col-sm-12.col-12.fondomundo3.ps-4
    ...
    p.mt-5(data-aos="fade-right") En el 2012, en Colombia se genera una política de naturaleza, y su objetivo es “posicionar a Colombia como destino de turismo de naturaleza, reconocido por el desarrollo de productos y servicios altamente competitivos y sostenibles”.
    ...
    .row.justify-content-center
      ...
      .col-xl-6.col-lg-5.col-10.my-5(data-aos="fade-right")
        img(src='@/assets/curso/tema1/imagen31.jpg', alt="Imagen decorativa")
    p.mt-5(data-aos="fade-right") Anteriormente por parte del turismo, Colombia no obtenía ingresos importantes debido a la inseguridad y la violencia en la que se había sumergido desde los años sesenta; sin embargo, este panorama cambió y en la última década bajo todas las políticas públicas, el país ha tenido un desarrollo económico y cultural exponencial, lo que ha ayudado a que el sector turismo ocupe una de las bases fundamentales del país.
    ...
    .row.ampliarambos.justify-content-center.fondo40
      .col-lg-8.col-10(data-aos="fade-right")
        img(src='@/assets/curso/tema1/imagen32.png', alt="Imagen decorativa")
    .row.justify-content-around.align-items-center.mt-3
      .col-xxl-10.col-xl-11.col-lg-11.col-12.col-md-12(data-aos="fade-right")
        .tarjeta.fondo8.p-3.mb-5
          .row.justify-content-between.align-items-center
    ...
    .row.justify-content-center.mb-5
      .col-lg-6.col-8(data-aos="fade-right")
