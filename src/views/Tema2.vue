  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      .col-12.px-5
        .row.justify-content-center
          .col-lg-6.col-10.mb-lg-0.mb-4(data-aos="fade-right")
            img(src='@/assets/curso/tema2/imagen1.jpg', alt="Imagen decorativa")
          ...
          .row.justify-content-center.mb-5
            .col-lg-6.order-lg-1.order-2
              p(data-aos="fade-right") Según Sernatur (2017) lo anterior puede generar dos beneficios esenciales:
              ul.lista-ul
    ...
    SlyderF.mb-5(columnas="col-lg-4" data-aos="zoom-in")
      .tarjeta.p-4.fondo44.h-100
        ...
        p.text-dark.text-center.mx-4.mb-0 Persona o grupo de personas que vive la experiencia.
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider2.png', alt="Imagen decorativa")
        h4.text-dark.text-center Acciones
        p.text-dark.text-center.mx-4.mb-0 Pueden ser nucleares (definen una experiencia) y auxiliares o de soporte (ir a comer, al baño, etc.) Una misma acción puede ser nuclear y auxiliar, según el diseño específico de la experiencia.
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider3.png', alt="Imagen decorativa")
        h4.text-dark.text-center Lugar
        p.text-dark.text-center.mx-4.mb-0 Es el entorno en donde transcurre un episodio de la experiencia. Incluye paisaje, arquitectura, mobiliario, colores, olores, sonidos, etc.
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider4.png', alt="Imagen decorativa")
        h4.text-dark.text-center Relatos
        p.text-dark.text-center.mx-4.mb-0 Mensajes expresados por los mediadores que sustentan la experiencia.
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider5.png', alt="Imagen decorativa")
        h4.text-dark.text-center Mediadores
        p.text-dark.text-center.mx-4.mb-0 Persona que interactúa con quienes viven la experiencia. Puede conducir la experiencia o un episodio en su totalidad, o solo estar a cargo de algunas acciones específicas (recepcionista, garzones, etc.)
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider6.png', alt="Imagen decorativa")
        h4.text-dark.text-center Elementos de mediación
        p.text-dark.text-center.mx-4.mb-0 Todo tipo de medios, objetos e instalaciones (folletos, vídeos, señaléticas, audio guías, etc.) especialmente diseñados para proveer claves de interpretación sobre lo que los protagonistas viven la experiencia.
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-6.col-10.mb-lg-0.mb-4(data-aos="fade-right")
        img(src='@/assets/curso/tema2/imagen5.jpg', alt="Imagen decorativa")
      .col-lg-6(data-aos="fade-left")
        LineaTiempoD
    ...
    .bloque-texto-g.fondo25.p-3.p-sm-4.p-md-5.mb-5.otrobloque2
      .bloque-texto-g__img(
        :style="{'background-image': `url(${require('@/assets/curso/tema2/imagen6.jpg')})`}" data-aos="fade-right"
      )
