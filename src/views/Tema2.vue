...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center.ampliarambos.fondo42.mb-5
      .col-12.px-5
        .row.justify-content-center
          .col-lg-6.col-10(data-aos="fade-right")
            img.mt-4(src='@/assets/curso/tema2/imagen1.jpg', alt="Imagen decorativa")
          ...
          p.mb-5 Ofrecer experiencias de calidad es un factor indispensable para ser competitivo en el sector turístico y para orientarse hacia las necesidades del público objetivo, ahorrando de esa manera los costos e inversiones innecesarias que dejen por fuera nuestro nicho de valor estratégico.
          .row.justify-content-center
            .col-lg-6(data-aos="fade-right")
              p Según Sernatur (2017) lo anterior puede generar dos beneficios esenciales:
              ul.lista-ul
                li.otrocolorcheck
                  i.fas.fa-check
                  p.mb-0 #[b Mayor satisfacción y recordación por parte de los visitantes]: es la base para fidelizar al público actual y para atraer otros nuevos.
                li.otrocolorcheck
                  i.fas.fa-check
            ...
            p.mb-5 Hay unos elementos específicos, que permiten tener una experiencia turística, estos son:
          .row.ps-5
            .col-xxl-5.col-xl-6.col-lg-7.col-md-10.fondomundo4.ps-sm-1.ps-4(data-aos="fade-right")
              h3.ps-5.pt-5.pb-2.margin-5 Elementos de una experiencia turística

    SlyderF.mb-5(data-aos="fade-right")(columnas="col-lg-4 col-xl-4")
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider1.png', alt="Imagen decorativa")
        h4.text-dark.text-center Protagonista
        p.text-dark.text-center.mx-4 Persona o grupo de personas que vive la experiencia.
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider2.png', alt="Imagen decorativa")
      ...
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider3.png', alt="Imagen decorativa")
      ...
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider4.png', alt="Imagen decorativa")
      ...
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider5.png', alt="Imagen decorativa")
      ...
      .tarjeta.p-4.fondo44.h-100
        .row.justify-content-center.mb-3
          .col-lg-7.col-10
            img(src='@/assets/curso/tema2/slider6.png', alt="Imagen decorativa")
    ...
    .row.justify-content-center.align-items-center
      .col-lg-6.col-md-10.order-lg-1.order-2(data-aos="fade-right")
        LineaTiempoD
      ...
      .col-lg-6.col-10.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-left")
        img.mt-4(src='@/assets/curso/tema2/imagen4.jpg', alt="Imagen decorativa")
    .row.justify-content-center.align-items-center
      .col-lg-6.col-10(data-aos="fade-right")
        img.mt-4(src='@/assets/curso/tema2/imagen5.jpg', alt="Imagen decorativa")
      .col-lg-6.col-md-10.mb-5.mb-md-0.mt-4(data-aos="fade-left")
        LineaTiempoD
    ...
    .bloque-texto-g.fondo25.p-3.p-sm-4.p-md-5.mb-5.otrobloque2(data-aos="fade-right")
      .bloque-texto-g__img(
    ...
    p(data-aos="fade-right") Con el fin de clarificar las dudas que surjan a partir de la creación de políticas de servicio, se ha construido el siguiente recurso:
    ...
    SlyderF.mb-5(columnas="col-lg-4" data-aos="fade-right")
      .tarjeta.p-4.fondo19.h-100
        .row.justify-start-center.mb-3.align-items-center
          .col-xl-5.col-lg-4.col-md-3.col-sm-4.col-4.mt-4
      ...
      .tarjeta.p-4.fondo19.h-100
        .row.justify-content-start.mb-3.align-items-center
          .col-xl-5.col-lg-4.col-md-3.col-sm-4.col-4.mt-4
            img(src='@/assets/curso/tema2/slider2-1.png', alt="Imagen decorativa")
          .col-xxl-7.col-xl-7.col-lg-8.p-0.mt-4
            h4 2. Comparar
    ...
    .row.justify-content-center
      ...
      .col-xl-6.col-lg-5.col-md-8(data-aos="fade-left")
      ...
      .col-xxl-12.px-5
        ...
        .row.justify-content-center
          .col-lg-6.col-md-8(data-aos="fade-right")
            img.mt-4(src='@/assets/curso/tema2/imagen8.jpg', alt="Imagen decorativa")
          .col-lg-6.col-md-8(data-aos="fade-left")
            .cajon.puntacajon3.p-4.mb-4.fondo43.mt-4.sombracajon
    ...
    .row.justify-content-center.align-items-center
      .col-lg-7.col-md-10.order-lg-1.order-2(data-aos="fade-right")
        LineaTiempoD
      ...
      .col-lg-5.col-md-8.col-10.order-lg-2.order-1.mb-lg-0.mb-4(data-aos="fade-left")
        img.mt-4(src='@/assets/curso/tema2/imagen9.jpg', alt="Imagen decorativa")
